...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-warm pattern-overlay py-12 px-4">
      <motion.div
      ...
      >
        ...
        <Card className="backdrop-blur-ethiopian bg-background/95 shadow-2xl border-0">
          <CardHeader className="space-y-1 text-center pb-8">
            ...
            >
              <div className="mx-auto w-16 h-16 bg-gradient-ethiopian rounded-full flex items-center justify-center mb-4">
              ...
              <CardTitle className="text-2xl font-bold font-ethiopic">
                መለያ ይፍጠሩ
              </CardTitle>
              <CardDescription className="text-base">
                Join EthioShop and start shopping today
              </CardDescription>
              <CardDescription className="text-sm font-ethiopic">
                ኢትዮሾፕ ይቀላቀሉ እና ዛሬ መግዛት ይጀምሩ
              </CardDescription>
            </motion.div>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    className="pl-10 pr-10 focus-ring rounded-lg h-12"
                    required
                  />
                  <button
                    type="button"
